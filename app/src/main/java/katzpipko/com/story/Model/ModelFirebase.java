...
// ...
             ...
             public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                Model.UID="";
                 ...
                 if (task.isSuccessful()) {
                     ...
                     SetUserProfileByUid(task.getResult().getUser().getUid(), new CallBackGeneric() {
                         @Override
...

    {
        ...
        myRef.child(uid).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                callBackGeneric.OnComplete(user);
            }
    ...
    public void SetUserProfileByUid(String uid, final ModelFirebase.CallBackGeneric callBackGeneric)
    ...
    public void RemoveStory(Story story, final ModelFirebase.CallBackGeneric callBackGeneric)
    {
        ...
        myRef.child(story.uid).child(story.storyID).removeValue();
        myRef.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                callBackGeneric.OnComplete(dataSnapshot);
            }

            @Override
            public void onCancelled(DatabaseError databaseError) {

                callBackGeneric.OnError(databaseError);
            }
        });
